...
variable "storage_account_name_for_ai" {
  description = "Specifies the name of the log analytics workspace"
  default     = "storageaerotronics"
  type        = string
}
variable "storage_container_name_for_ai" {
  description = "Specifies the name of the log analytics workspace"
  default     = "aimaindata"
  type        = string
}
variable "appserviceplan_name" {
  description = "Specifies the name of the log analytics workspace"
  default     = "mainserviceplan"
  type        = string
}
variable "webapp_name" {
  description = "Specifies the name of the log analytics workspace"
  default     = "aiwebfrontend"
  type        = string
}
